...
const CampusCard = ({ title, description, image, onPress, isEnabled }) => {
  // Kleurenset van de campuscard voor light mode / dark mode
  ...
  return (
    <View style={[styles.card, { backgroundColor: colors.card }]}>
      ...
      {/* Kleine labeltekst */}
      <Text style={[styles.category, { color: colors.subText }]}>Campus</Text>
